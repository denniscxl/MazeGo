...
// https://github.com/WestHillApps/uGUI-Effect-Tool/blob/master/Assets/uGuiEffectTool/UIEffect/GKBlendColor.cs
...
namespace GKUI
{
    ...
    public class GKBlendColor : BaseVertexEffect
#else
	public class GKBlendColor : BaseMeshEffect
#endif
	{
